...
a.box:hover, a.box:focus {
  box-shadow: 0 2px 3px rgba(17, 17, 17, 0.1), 0 0 0 1px #75c5f7; }
a.box:active {
  box-shadow: inset 0 1px 2px rgba(17, 17, 17, 0.2), 0 0 0 1px #75c5f7; }
...
a.nav-item {
  ...
  a.nav-item.is-tab {
    ...
    a.nav-item.is-tab:hover {
      border-bottom: 1px solid #75c5f7;
      border-top: 1px solid transparent; }
    .nav-item a.is-tab.is-active,
    a.nav-item.is-tab.is-active {
      border-bottom: 3px solid #75c5f7;
...
.hero {
  ...
  .hero.is-primary {
    ...
    .hero.is-primary.is-bold {
      background-image: linear-gradient(141deg, #3bd4fe 0%, #75c5f7 71%, #8abdfb 100%); }
    @media screen and (max-width: 768px) {
...
/*# sourceMappingURL=letsgospb.css.map */
